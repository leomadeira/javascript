const raio = 5.6
const area = Math.PI * Math.pow(raio, 2) // Math está colocando o valor de PI=> (pi*5.6²) <= e jogando a potência de 2 com o pow(potencia)
...
console.log(typeof Math) // Math é um objeto padrão do JS
